...
class Concat{
    ...
    init(){
        ...
        let footer = '\nrequirejs.config({paths:{"text": "lib/requirejs/text", "component": "//component.vipstatic.com/mobile/scripts/common/modules", "globaljs": "//component.vipstatic.com/mobile/scripts"}})';
